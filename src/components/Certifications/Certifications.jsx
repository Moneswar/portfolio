...
/**
 * Certifications
 * Premium recruiter-focused credentials & academic coursework showcase.
 * Displays verified professional certifications and completed one-credit courses in a balanced 2x2 grid.
 */
  ...
  return (
    <section id="certifications" className="relative py-20 sm:py-28 lg:py-32">
      <div className="container-px mx-auto max-w-[1240px]">
        ...
        {/* 2x2 Responsive Grid for Certifications & One-Credit Courses */}
          ...
          {certifications.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-5 flex items-center justify-between">
                    ...
                    {item.year ? (
                      ...
                      <span className="inline-flex items-center gap-1.5 rounded-full border border-purple-500/30 bg-purple-500/10 px-3.5 py-1 font-mono text-xs font-semibold uppercase tracking-wider text-purple-300 shadow-sm">
                        {item.badge}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col gap-3.5">
                    ...
                    <div className="flex items-center justify-between gap-4 rounded-xl border border-white/5 bg-white/[0.02] p-3 sm:p-3.5 transition-colors group-hover:border-white/10">
                      <div className="flex items-center gap-2.5 text-xs font-mono font-medium text-slate-400 shrink-0">
                        <FiBookOpen className="text-cyan-400 text-sm shrink-0" />
                        <span>Course</span>
                      </div>
                      <span className="text-xs sm:text-sm font-semibold text-slate-200 text-right leading-snug">
                        {item.course}
                      </span>
                    </div>
                ...
                {/* Bottom Verification Status / Action */}
                  ...
                  {item.credentialUrl ? (
                    ...
                    <div className="flex items-center justify-between text-xs text-slate-400">
                      <span className="inline-flex items-center gap-1.5 text-[11px] font-mono text-cyan-300/90">
                        ...
                        {item.statusText || "Verified Credential"}
                      </span>
